...
/*$(".cart").click(function(){
    alert("work");
    let cimg =$(this).parent(".card-body").siblings(".card-img-top").attr("src");
    let pname =$(this).siblings(".cname").html();
    let desc =$(this).siblings(".cdesc").html();
    let price =$(this).siblings(".cprice").html();
